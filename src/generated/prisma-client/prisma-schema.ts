...
input MyDeviceScalarWhereInput {
  ...
  calibration: DateTime
  calibration_not: DateTime
  calibration_in: [DateTime!]
  calibration_not_in: [DateTime!]
  calibration_lt: DateTime
  calibration_lte: DateTime
  calibration_gt: DateTime
  calibration_gte: DateTime
  next_calibration: DateTime
  next_calibration_not: DateTime
  next_calibration_in: [DateTime!]
  next_calibration_not_in: [DateTime!]
  next_calibration_lt: DateTime
  next_calibration_lte: DateTime
  next_calibration_gt: DateTime
  next_calibration_gte: DateTime
  createdAt: DateTime
  createdAt_not: DateTime
  createdAt_in: [DateTime!]
  createdAt_not_in: [DateTime!]
