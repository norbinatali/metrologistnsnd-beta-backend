...
input MyDeviceScalarWhereInput {
  ...
  calibration_data: String
  calibration_data_not: String
  calibration_data_in: [String!]
  calibration_data_not_in: [String!]
  calibration_data_lt: String
  calibration_data_lte: String
  calibration_data_gt: String
  calibration_data_gte: String
  calibration_data_contains: String
  calibration_data_not_contains: String
  calibration_data_starts_with: String
  calibration_data_not_starts_with: String
  calibration_data_ends_with: String
  calibration_data_not_ends_with: String
  valid_verification: String
